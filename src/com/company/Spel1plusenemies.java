...
public class Spel1plusenemies {
    ...
    private static boolean GameLogic(Player player, List<Enemy> enemy) {
        ...
        for (int j = 0; j < enemy.size(); j++) {
            ...
            int framellerbak = (int)(Math.random()*((3-1)+1));
            framellerbak *= Math.floor(Math.random()*2) == 1 ? 1 : -1;
            System.out.println("etttvå " + framellerbak);
            if (enemy.get(0).x == enemy.get(1).x && enemy.get(0).y == enemy.get(1).y){

                if(slump <= 50)
                    enemy.get(0).x += framellerbak;
                else
                    enemy.get(0).y += framellerbak;
            }
            else if (enemy.get(0).x == enemy.get(2).x && enemy.get(0).y == enemy.get(2).y){
            ...
            else if (enemy.get(0).x == enemy.get(3).x && enemy.get(0).y == enemy.get(3).y){
            ...
            else if (enemy.get(1).x == enemy.get(2).x && enemy.get(1).y == enemy.get(2).y){

                if(slump <= 50)
                    enemy.get(1).x += framellerbak;
                else
                    enemy.get(1).y += framellerbak;
            }
            else if (enemy.get(1).x == enemy.get(3).x && enemy.get(1).y == enemy.get(3).y){
            ...
            else if (enemy.get(2).x == enemy.get(3).x && enemy.get(2).y == enemy.get(3).y){

                if(slump <= 50)
                    enemy.get(2).x += framellerbak;
                else
                    enemy.get(2).y += framellerbak;
            }
